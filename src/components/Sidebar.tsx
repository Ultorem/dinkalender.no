...
import { ChevronLeft, ChevronRight, CheckSquare, Droplet } from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  return (
    ...
    `}>
      ...
      <div className="w-80 bg-white dark:bg-gray-800 rounded-l-lg shadow-lg p-4 space-y-6">
